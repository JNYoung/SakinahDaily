...
qibla_viewed,qibla_open,"screen|route|calculation_method|location_method|source=settings|source=manual_location|source=direct","latitude|longitude|location_label|qibla_bearing_degrees|women_ibadah_status|feedback_text",Qibla View Rate
...
Qibla View Rate,/qibla,qibla_viewed,"settings, manual_location, or direct",screen route coarse method and controlled source,no exact coordinates selected place label or bearing degrees
...
- Qibla page open from Settings/manual location/direct route.
