...
class AnalyticsParameterPolicy {
  ...
  static const _prayerLocationChangedKeys = {
    'calculation_method',
    'change_type',
    'location_method',
    'source',
  ...
  static const _notificationSettingsViewedKeys = {
    'screen',
    'source',
    'prayer_reminders_enabled',
  };
  ...
  static const _notificationTapResultKeys = {
    'content_type',
    'source',
    'change_type',
  };
  ...
  static bool _isAllowedForEvent(String key, String? eventName) {
    return switch (eventName) {
      ...
      AnalyticsEventCatalog.prayerLocationChanged =>
        _prayerLocationChangedKeys.contains(key),
