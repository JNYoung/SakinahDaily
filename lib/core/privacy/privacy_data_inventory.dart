...
abstract final class PrivacyDataInventory {
  static const categories = [
    ...
    PrivacyDataCategory(
      id: 'analytics_consent_preference',
      displayNameKey: 'privacyDataAnalyticsConsent',
      storageLocation: PrivacyStorageLocation.localDevice,
      sensitivity: PrivacySensitivity.low,
      leavesDevice: false,
      userCanDelete: true,
      notesKey: 'privacyDataAnalyticsConsentNotes',
    ),
    PrivacyDataCategory(
      id: 'default_off_analytics_events',
      displayNameKey: 'privacyDataAnalyticsEvents',
      storageLocation: PrivacyStorageLocation.remoteOptional,
      sensitivity: PrivacySensitivity.medium,
      leavesDevice: true,
      userCanDelete: false,
      notesKey: 'privacyDataAnalyticsEventsNotes',
    ),
    PrivacyDataCategory(
      id: 'future_crash_reporting',
