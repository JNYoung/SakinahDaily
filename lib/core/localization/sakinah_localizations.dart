...
class SakinahLocalizations {
  ...
  static const _values = {
    'en': {
      ...
      'continuePrayerCheckIn': 'Continue prayer check-in',
      'reviewPrayerCheckIn': 'Review prayer check-in',
    ...
    'id': {
      ...
      'continuePrayerCheckIn': 'Lanjutkan check-in shalat',
      'reviewPrayerCheckIn': 'Tinjau check-in shalat',
    ...
    'ar': {
      ...
      'continuePrayerCheckIn': 'متابعة تسجيل الصلاة',
      'reviewPrayerCheckIn': 'مراجعة تسجيل الصلاة',
