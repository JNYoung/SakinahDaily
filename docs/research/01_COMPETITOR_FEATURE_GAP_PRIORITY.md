...
Status: local Set daily reminder CTA implemented on 2026-05-30; richer
reminder controls remain open.
...
- Open: Prayer reminders support at least per-prayer on/off or a documented v0.1
  deferral.
- Open: user-selectable session reminder time and next-session suggestions are
  not implemented yet.
