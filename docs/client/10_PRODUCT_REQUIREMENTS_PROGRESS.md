...
completed onboarding directly to Home without showing a second Flutter brand
screen. Legacy saved preference records that predate the completion flag count
as completed onboarding, so existing testers are not forced back through setup
after an app update.
