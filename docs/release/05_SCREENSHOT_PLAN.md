...
`sakinah_native_splash.png`; Android 12+ uses the historical Flutter
brand-screen mark and branding image as visible native splash resources. iOS
uses the same bitmap through
