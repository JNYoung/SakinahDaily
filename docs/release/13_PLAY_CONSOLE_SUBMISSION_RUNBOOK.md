...
This runbook is the Play Console submission pack for Misbah Daily. It turns
...
| Package name | `com.misbahdaily.app` |
| First Android version | `0.1.0` |
| First version code | `1` |
| Default release track | Closed testing / Alpha |
| Tester group | `misbah-daily-testers@googlegroups.com` |
| Web opt-in link | `https://play.google.com/apps/testing/com.misbahdaily.app` |
| Store listing link | `https://play.google.com/store/apps/details?id=com.misbahdaily.app` |
...
- Target audience and content: Misbah Daily is not designed for children. The
...
- Add `misbah-daily-testers@googlegroups.com` to the Closed testing track.
