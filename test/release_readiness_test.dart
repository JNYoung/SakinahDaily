...
void main() {
  ...
  group('build flavor config', () {
    ...
    test('privacy-safe Google Analytics event contract is documented', () {
      ...
      expect(analyticsPlan, contains('qibla_page'));
...
''');
    ...
    test('Google Analytics DebugView QA packet can be exported', () {
      ...
      expect(content, contains('qibla_page'));
      ...
      expect(funnel, contains('qibla_page'));
      ...
      expect(funnel, contains('notification_permission_recovery_opened'));
...
''');
    ...
    test('native icon and splash review evidence is documented', () {
      ...
      expect(androidChecklist, contains('historical Flutter'));
      expect(androidChecklist, contains('brand-screen artwork'));
    ...
    test('prayer page all-day times and reminder toggle acceptance are covered',
      ...
      final navigationTest =
          File('test/navigation_flow_test.dart').readAsStringSync();
      final qiblaPageTest =
          File('test/qibla_page_test.dart').readAsStringSync();
      ...
      expect(qiblaPage, contains('qiblaChangeLocationButton'));
      expect(
          qiblaPage, contains('/settings/prayer-location?source=qibla_page'));
      ...
      expect(keys, contains('qiblaChangeLocationButton'));
      ...
      expect(router, contains('qibla_page'));
      expect(
        navigationTest,
      ...
      expect(
        manualLocationTest,
        contains('manual prayer location save can return to Qibla from Qibla'),
      );
      expect(
        qiblaPageTest,
        contains('Qibla page opens manual location setup from Qibla context'),
      );
      expect(
        navigationTest,
    ...
    test('push module completion and analytics coverage are audited', () {
      ...
      expect(notificationSettings, contains('notificationSettingsViewed'));
      expect(notificationSettings,
          contains('notificationPermissionRecoveryButton'));
      expect(
      ...
      expect(
        notificationServiceTest,
        contains('notification settings recovery opens system settings'),
      );
      expect(
        notificationSettingsTest,
        contains('Home prayer card can enable reminders without leaving Home'),
      ...
      expect(
        notificationSettingsTest,
        contains('Prayer reminder permission recovery opens system settings'),
      );
      expect(
        notificationSettingsTest,
        contains(
